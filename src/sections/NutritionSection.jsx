...
const NutritionSection = () => {
  ...
  return (
    <section className="nutrition-section">
      ...
      <img src="/images/bg-big.png" alt="" className="big-img" />

      <div className="flex md:flex-row flex-col justify-between md:px-10 px-5 mt-14 md:-mt-23">
            ...
            {lists.map((nutrient, index) => (
              <div key={index} className="relative flex-1 col-center">
                <div>
                  ...
                  <p className="font-paragraph text-sm mt-2">Brimming with</p>
